	...
	<div class="container">
		<div class="card mt-5">
			 <div class="card-body">
	    		...
	    		<a href="indexcopia.php">Lista de Produtos</a>
	    	</div>
		</div>
		...
		<?php if($resultsCarts) : ?>
			...
			<a class="btn btn-primary" href="indexcopia.php">Continuar Comprando</a>
			<button class="btn btn-primary" type="submit">Atualizar Carrinho</button>
            <a class="btn btn-primary" href="compra-finalizada.php">Finalizar Compra</a>
